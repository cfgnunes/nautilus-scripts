...
_main() {
    ...
    __echo_script "$script_test"
    bash "$ROOT_DIR/$script_test" "$input_file1" >"$std_output"
    __test_file_nonempty "$output_file.mp3 (1).bak"
    __test_file_empty "$std_output"

    #script_test="Audio and video/Audio: MP3 files/MP3: Repair (recursive)"
    #__echo_script "$script_test"
    #bash "$ROOT_DIR/$script_test" "$input_file1" >"$std_output"
    #__test_file_nonempty "$output_file.mp3 (2).bak"
    #__test_file_empty "$std_output"
    ...
    __echo_script "$script_test"
    bash "$ROOT_DIR/$script_test" "$input_file1" "$input_file2" >"$std_output"
    __test_file_nonempty "$_TEMP_DIR_TEST/Concatenated media.mp3"
    __test_file_empty "$std_output"
    ...
    __echo_script "$script_test"
    bash "$ROOT_DIR/$script_test" "$input_file1" >"$std_output"
    __test_file_nonempty "$_TEMP_DIR_TEST/test audio - test audio.mp3"
    __test_file_empty "$std_output"
    ...
    __echo_script "$script_test"
    bash "$ROOT_DIR/$script_test" "$input_file1" "$input_file2" >"$std_output"
    __test_file_nonempty "$_TEMP_DIR_TEST/Concatenated media.mp4"
    __test_file_empty "$std_output"
    ...
    __echo_script "$script_test"
    bash "$ROOT_DIR/$script_test" "$input_file1" >"$std_output"
    __test_file_nonempty "$output_file (cropped) (1).png"
    __test_file_empty "$std_output"
